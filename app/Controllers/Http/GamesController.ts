...
export default class GamesController {
  public async index({ request, response }: HttpContextContract) {
    try {
      ...
      gamesJSON.data = gamesJSON.data.map((game) => {
        game.price = game.price.toLocaleString('pt-BR', {
          style: 'currency',
          currency: 'BRL',
        })
  ...
  public async store({ request }: HttpContextContract) {
    ...
    game.price = game.price.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })
  ...
  public async show({ params, response }: HttpContextContract) {
    try {
      ...
      gameJSON.price = gameJSON.price.toLocaleString('pt-BR', {
        style: 'currency',
        currency: 'BRL',
      })
